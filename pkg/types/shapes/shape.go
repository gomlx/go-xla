...
//
// Go float16 and bfloat16 support (commonly used by Nvidia GPUs) uses a minimal implementation under
// github.com/compute/dtypes/float16 and github.com/compute/dtypes/bfloat16.
//
// ## Glossary
//
